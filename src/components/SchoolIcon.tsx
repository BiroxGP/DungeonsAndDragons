...
const SCHOOL_PATHS: Record<string, ReactNode> = {
  abjuration: <path d="M12 2 4 5v6c0 5 3.5 9 8 11 4.5-2 8-6 8-11V5z" />,
  conjuration: (
  ...
  enchantment: <path d="M12 21S4 14 4 8.5C4 5 6.5 3 9 3c1.5 0 2.6 1 3 2 .4-1 1.5-2 3-2 2.5 0 5 2 5 5.5C20 14 12 21 12 21Z" />,
  evocation: <path d="M12 2C9 6 6 9.5 6 14a6 6 0 0 0 12 0c0-2-1-3.6-2-5 .2 1.3-.3 2.2-1 2.7C15.6 8 12 2 12 2Z" />,
  illusion: (
